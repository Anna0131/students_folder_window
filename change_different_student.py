...
def open_folder():
    ...
    if base_folder:
        ...
        student_buttons_frame = ttk.Frame(root)  # 創建另一個 Frame 用於學生切換清單
        ...
        nb.pack(side=tk.LEFT, fill="both", expand=True)  # 將 nb 放置在 student_buttons_frame 的右側
